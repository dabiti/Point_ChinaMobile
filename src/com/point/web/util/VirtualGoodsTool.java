...
public class VirtualGoodsTool {
	...
	public static void sendRequest(JSONObject userJson) {
		// 获得公共参数
		...
		String sign = toSign(beforeSort);
		System.out.println("签名：" + sign);
		// 最终参数
		// String req = "req="+Base64.encodeBytes( (sign +
		// beforeSort).getBytes());
		...
		String returnStr = sendPost(PublicMap.get("url"), req);
	...
	// 验证参数
	public final static boolean verifyParameter(String msg) {
